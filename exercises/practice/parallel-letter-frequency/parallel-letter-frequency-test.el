;;; parallel-letter-frequency-test.el --- Parallel Letter Frequency (exercism)  -*- lexical-binding: t; -*-
...
(load-file "parallel-letter-frequency.el")
(declare-function calculate-frequencies "parallel-letter-frequency.el" (texts))
...
(provide 'parallel-letter-frequency-test)
;;; parallel-letter-frequency-test.el ends here

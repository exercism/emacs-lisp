...
(ert-deftest root-of-1 ()
  (should (equal 1 (square-root 1))))


(ert-deftest root-of-4 ()
  (should (equal 2 (square-root 4))))


(ert-deftest root-of-25 ()
  (should (equal 5 (square-root 25))))


(ert-deftest root-of-81 ()
  (should (equal 9 (square-root 81))))


(ert-deftest root-of-196 ()
  (should (equal 14 (square-root 196))))


(ert-deftest root-of-65025 ()
  (should (equal 255 (square-root 65025))))
